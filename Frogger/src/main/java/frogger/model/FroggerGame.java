...
/**
 * FroggerGame is the Orchestrator: holds basic state (time, lives, score) and implements Game interface.
 * - It wires LevelManager, PlayerManager and CollisionManager.
 */
public class FroggerGame implements Game {
    ...
    public void updateGame() {
        ...
        // Forward progress points
        if (result.forwardPoints > 0) {
            score += result.forwardPoints;
        }
